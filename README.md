...
| [obsidian-cli](skills/obsidian-cli) | Comprehensive reference for the [Obsidian CLI](https://help.obsidian.md/cli) (70+ commands) — file ops, search, properties, tasks, bases, sync, plugins, and developer tools |
| [vault-audit](skills/vault-audit) | Audit vault health — broken links, orphan notes, dead ends, tag/property consistency |
